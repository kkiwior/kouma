...
describe('retentionService', () => {
    ...
    describe('applyRetentionForAllProjects', () => {
        it('should iterate all projects and apply retention', async () => {
            const projects = [
                { pid: 'p1', projectName: 'proj1', sharedProjectRootPath: '/data/proj1', retentionPolicyType: 'none', retentionPolicyValue: 0 },
                { pid: 'p2', projectName: 'proj2', sharedProjectRootPath: '/data/proj2', retentionPolicyType: 'builds', retentionPolicyValue: 5 },
            ];
        ...
        it('should continue processing other projects if one fails', async () => {
            const projects = [
                { pid: 'p1', projectName: 'proj1', sharedProjectRootPath: '/data/proj1', retentionPolicyType: 'builds', retentionPolicyValue: 1 },
                { pid: 'p2', projectName: 'proj2', sharedProjectRootPath: '/data/proj2', retentionPolicyType: 'none', retentionPolicyValue: 0 },
            ];
            (projectService.getAllProjects as any).mockResolvedValue(projects);
    ...
    describe('deleteBuildArtifacts', () => {
        it('should delete build directory if it exists', async () => {
            ...
            await retentionService.deleteBuildArtifacts(
                { pid: 'p1', sharedProjectRootPath: '/data/proj1' },
                { bid: 'b1', buildIndex: 3 },
            );
